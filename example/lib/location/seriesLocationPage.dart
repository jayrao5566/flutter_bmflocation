...
class _MyAppState extends State<SeriesLocationPage> {
  ...
  Future<void> _startLocation() async {
    await _myLocPlugin.enableLocInForeground('com.baidu.flutter_bmflocation', 'FLUTTER CHANNEL',
  ...
  void _stopLocation() async {
    bool _suc1 = await _myLocPlugin.disableLocInForeground();
    print('停止前台服务：$_suc1 =');
    if (_suc1) {
